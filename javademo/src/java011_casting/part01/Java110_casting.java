...
public class Java110_casting {
	...
	public static void main(String[] args) {
		...
		Object oct = str;  // - 업캐스팅(up-casting) :  부모객체로 자식객체를 참조할도록 형변환하는 기술		
		System.out.println(oct.toString());
//		System.out.println(oct.charAt(0));    업캐스팅 해도 str에 있던         
		
		Object oea = new String("java");
		System.out.println(oea.toString());
		
		String ste = (String)oea; //  - 다운캐스팅(down-casting) : 업캐스팅을 다시 원상복귀해주는 형변환하는 기술
