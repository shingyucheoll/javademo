...
public class Java105_interface {
	...
	public static void main(String[] args) {
		CarRun.dispaly();    // interface의 static method는 선언만 해주면 바로 사용할 수 있다.
//		CarRun.call();    // static이 아니여서 사용할 수 없다.
		
		System.out.println(CarRun.carCount);	// inter의 변수는 선언만 해주면 바로 불러올 수 있다.  interface.variable
